...
public class SignUpAsTeacher extends AppCompatActivity {
   ...
   public void validate() {
    ...
    class Send extends AsyncTask<String,Integer,String>
    {
        ...
        String querry="select * from teacherrequest" +
                " where username='"+editText4.getText().toString()+"'";
        String querryT="select * from teacher" +
                " where username='"+editText4.getText().toString()+"'";
        ...
        protected String doInBackground(String... strings) {
            try {
                ...
                {   Statement smt=con.createStatement();
                    ...
                    if((smt.executeQuery(querry).next())||(smt.executeQuery(querryT).next()))
                    {
                        result="true";
                        }
                    else
...
return null;
        ...
        protected void onPostExecute(String s) {
            ...
            {
                Toast.makeText(SignUpAsTeacher.this,"Check Your Connection",Toast.LENGTH_SHORT).show();
            }

            else if(result.equals("false")) {
                Intent intent = new Intent(SignUpAsTeacher.this, SignUpAsTeacher2.class);
